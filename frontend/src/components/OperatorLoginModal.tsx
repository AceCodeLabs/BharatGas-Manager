              ...
              {step === 'mobile' ? (
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6">
                  ...
                  <div className="flex flex-col gap-3">
                    <button type="button" onClick={() => setStep('mobile')} className="text-[10px] font-black text-gray-500 uppercase tracking-widest hover:text-white transition-colors">
                      Change Number
                    </button>
                    <button type="button" className="flex items-center justify-center gap-2 text-[10px] font-black text-green-500/60 uppercase tracking-widest hover:text-green-500 transition-colors">
