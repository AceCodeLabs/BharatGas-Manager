...
import { Repeat, ArrowUpRight, ArrowDownLeft, Wallet, Flame } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto min-h-screen bg-[#0a0a0a]">
      ...
      <header className="mb-10">
        ...
        <p className="text-gray-500 text-sm">History of point usage and account adjustments</p>
      </header>
        ...
        <div className="lg:col-span-2 space-y-4">
            <div className="bg-[#141414] border border-white/5 rounded-[2.5rem] p-8 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-4 mb-6">
                    <div className="size-12 rounded-2xl bg-green-500/10 flex items-center justify-center text-green-500 shadow-inner">
                        <Flame className="size-6" />
                    </div>
                    <div>
                        <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Available Balance</p>
                        <h2 className="text-4xl font-black text-white mt-1 tracking-tight">{profile?.totalPoints ?? 0} <span className="text-sm font-bold text-gray-600 uppercase tracking-widest">pts</span></h2>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <button className="bg-green-500 hover:bg-green-600 text-black px-8 py-3.5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all active:scale-95 shadow-lg shadow-green-500/20">
                        Top Up Points
                    </button>
                </div>
            </div>
                    ...
                    {transactions.length === 0 ? (
                        ...
                        >
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">PTS</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
            ...
            <div className="p-6 text-center border-t border-white/5">
                <button className="text-xs font-black text-gray-500 uppercase tracking-widest hover:text-green-500 transition-colors">Show All Transactions</button>
            </div>
        </div>
        ...
        <div className="space-y-6">
            <div className="bg-gradient-to-br from-[#141414] to-black border border-white/5 rounded-[2.5rem] p-8 shadow-2xl">
                ...
                <div className="mt-10 p-6 bg-white/5 rounded-[2rem] border border-white/5">
                    <p className="text-[10px] font-black text-gray-500 uppercase mb-2">Predicted Monthly Usage</p>
                    <p className="text-2xl font-black text-white">4,820 pts</p>
                    <p className="text-[10px] font-bold text-green-500 mt-1 uppercase tracking-tight">↓ 4% lower than last month</p>
                </div>
            </div>
            ...
            <div className="bg-[#141414] border border-green-500/20 rounded-[2.5rem] p-8 relative overflow-hidden group">
                ...
                <p className="text-sm font-bold text-gray-300 leading-relaxed mb-6">You're currently a VIP Manager with 2.5% point rebate on all orders.</p>
